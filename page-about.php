...
About
<main>
  <div class="relative overflow-hidden bg-gradient-to-b from-indigo-100/20 pt-14">
    <div
      class="absolute inset-y-0 right-1/2 -z-10 -mr-96 w-[200%] origin-top-right skew-x-[-30deg] bg-white shadow-xl shadow-red-600/10 ring-1 ring-red-50 sm:-mr-80 lg:-mr-96"
      aria-hidden="true"
    />
    <div class="mx-auto max-w-screen-xl px-6 py-32 sm:py-40 lg:px-8">
  ...
  <div class="mt-32 overflow-hidden sm:mt-40">
    <div class="mx-auto max-w-screen-xl px-6 lg:flex lg:px-8">
      <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-16 lg:mx-0 lg:min-w-full lg:max-w-none lg:flex-none lg:gap-y-8">
        <div class="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
          <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">公司位置</h2>
...
中心地带和郑州航空港区经济圈，郑少、郑尧、商登高速和郑登快速通道等骨干路网畅通便捷
  ...
  <div class="mx-auto my-32 max-w-screen-xl px-6 sm:mt-40 lg:px-8 space-y-20">
    <div>
